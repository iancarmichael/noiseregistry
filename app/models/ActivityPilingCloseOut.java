...
public class ActivityPilingCloseOut extends DefaultableActivity
{
    @Id
	...
	public void populateDefaults() {
		if (getMax_hammer_energy_actual()==null)
			setMax_hammer_energy_actual(getAa().getActivityPiling().getMax_hammer_energy());
		if (getSound_pressure_level_actual()==null)
			setSound_pressure_level_actual(getAa().getActivityPiling().getSound_pressure_level());
		if (getSound_exposure_level_actual()==null)
			setSound_exposure_level_actual(getAa().getActivityPiling().getSound_exposure_level());		
	}
