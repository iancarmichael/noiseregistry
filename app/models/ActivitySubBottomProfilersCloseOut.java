...
public class ActivitySubBottomProfilersCloseOut extends DefaultableActivity
{
    @Id
	 ...
	 * Constructor
	 */
	public ActivitySubBottomProfilersCloseOut() {
		super();
	}
	@Override
	public void populateDefaults() {
		if (getFrequency_actual()==null)
			setFrequency_actual(getAa().getActivitySubBottomProfilers().getFrequency());
		if (getSound_pressure_level_actual()==null)
			setSound_pressure_level_actual(getAa().getActivitySubBottomProfilers().getSound_pressure_level());
		if (getSound_exposure_level_actual()==null)
			setSound_exposure_level_actual(getAa().getActivitySubBottomProfilers().getSound_exposure_level());		
	}
